		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Rule • ' + (elm$core$String$fromInt(model.y) + 's left'))
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('rule-text')
					]),
				_List_fromArray(
					[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Score • Team 1 wins!')
					])) : ((_Utils_cmp(model.n, author$project$Main$winScore) > -1) ? A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Score • Team 2 wins!')
					])) : A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
