...
var author$project$Main$normalizeScore = F3(
	function (minScore, maxScore, score) {
		return (_Utils_cmp(score, minScore) < 0) ? minScore : ((_Utils_cmp(score, maxScore) > 0) ? maxScore : score);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					model,
					A2(elm$random$Random$generate, author$project$Main$NewWord, author$project$Main$randomWord));
			case 1:
				var newWord = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{y: author$project$Main$timeLimit}),
					A2(elm$random$Random$generate, author$project$Main$NewRule, author$project$Main$randomRule));
			case 3:
				var newRule = msg.a;
				return A2(author$project$Main$historyIncludes, newRule, model.I) ? _Utils_Tuple2(
					model,
					A2(elm$random$Random$generate, author$project$Main$NewRule, author$project$Main$randomRule)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							S: newRule,
					...
					elm$core$Platform$Cmd$none);
			case 4:
				var timeRemaining = model.y;
				var newModel = _Utils_update(
					model,
					{y: timeRemaining - 1});
				return (timeRemaining === 1) ? _Utils_Tuple2(
					newModel,
					author$project$Main$playSfx(
						elm$json$Json$Encode$bool(true))) : _Utils_Tuple2(newModel, elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: A3(author$project$Main$normalizeScore, 0, author$project$Main$winScore, model.m + 1)
						}),
					elm$core$Platform$Cmd$none);
			case 6:
				return _Utils_Tuple2(
			...
			case 7:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A3(author$project$Main$normalizeScore, 0, author$project$Main$winScore, model.n + 1)
						}),
					elm$core$Platform$Cmd$none);
			case 8:
				return _Utils_Tuple2(
...
var author$project$Main$viewRule = function (model) {
	var timeAndRule = (model.y > 0) ? _List_fromArray(
		[
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(
					'Time left: ' + (elm$core$String$fromInt(model.y) + 's'))
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
...
var author$project$Main$DecrementScore1 = {$: 6};
var author$project$Main$DecrementScore2 = {$: 8};
var author$project$Main$IncrementScore1 = {$: 5};
var author$project$Main$IncrementScore2 = {$: 7};
var author$project$Main$ResetScores = {$: 9};
var elm$html$Html$span = _VirtualDom_node('span');
var author$project$Main$viewScore = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				(_Utils_cmp(model.m, author$project$Main$winScore) > -1) ? A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Team 1 wins!')
					])) : ((_Utils_cmp(model.n, author$project$Main$winScore) > -1) ? A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$DecrementScore1)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('-')
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$IncrementScore1)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$DecrementScore2)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('-')
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$IncrementScore2)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$ResetScores)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Reset scores')
					]))
			]));
};
var author$project$Main$GetNewWord = {$: 0};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$toUpper(model.Y))
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$GetNewWord)
					]),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$src('/sounds/alarm.mp3'),
