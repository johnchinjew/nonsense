...
randomRule =
    Random.weighted
        -- Language challenges 10%
        ( 10 / 18, "Use ONLY words that do NOT contain the letter F." )
        [ ( 10 / 18, "Use ONLY words that do NOT contain the letter P." )
        , ( 10 / 18, "Use ONLY words that do NOT contain the letter K." )
        , ( 10 / 18, "Use ONLY words that do NOT contain the letter J." )
        , ( 10 / 18, "Use ONLY words that do NOT contain the letter L." )
        , ( 10 / 18, "Use ONLY words that starts with the letter E." )
        , ( 10 / 18, "Use ONLY words that starts with the letter T." )
        , ( 10 / 18, "Use ONLY words that starts with the letter A." )
        , ( 10 / 18, "Use ONLY words that starts with the letter R." )
        , ( 10 / 18, "Use ONLY words that starts with the letter N." )
        , ( 10 / 18, "Use ONLY words that rhyme with -ACK." )
        , ( 10 / 18, "Use ONLY words that rhyme with -AT." )
        , ( 10 / 18, "Use ONLY words that rhyme with -ATE." )
        , ( 10 / 18, "Use ONLY words that rhyme with -EET." )
        , ( 10 / 18, "Use ONLY words that rhyme with -ICK." )
        , ( 10 / 18, "Use ONLY words that rhyme with -IP." )
        , ( 10 / 18, "Use ONLY words that rhyme with -OON." )
        , ( 10 / 18, "Use ONLY words that rhyme with -UNK." )

        -- Word categories 34%
        , ( 34 / 8, "Use ONLY COLOR words." )
        , ( 34 / 8, "Use ONLY SIZE words (like tall or thin)." )
        , ( 34 / 8, "Use ONLY SHAPE words (like triangular or lopsided)." )
        , ( 34 / 8, "Use ONLY TEXTURE words." )
        , ( 34 / 8, "Use ONLY ACTION words (like run or jump)." )
        , ( 34 / 8, "Use ONLY SMELL words." )
        , ( 34 / 8, "Use ONLY TASTE words." )
        , ( 34 / 8, "Use ONLY EMOTION words." )

        -- Silly challenges 38%
        , ( 38 / 9, "You can ONLY POINT at things." )
        , ( 38 / 9, "USE ONLY HAND motions." )
        , ( 38 / 9, "You can ONLY say WARMER or COOLER." )
        , ( 38 / 9, "You can ONLY SING song LYRICS." )
        , ( 38 / 9, "Use ONLY SOUND EFFECTS." )
        , ( 38 / 9, "You can ONLY DRAW in the AIR." )
        , ( 38 / 9, "You can ONLY say WARMER or COOLER." )
        , ( 38 / 9, "Use ONLY your EYES to POINT at things." )
        , ( 38 / 9, "Freestyle a RAP that RHYMES." )

        -- Other 10%
        , ( 10 / 3, "Use ONLY types of WEATHER (like rainy)." )
        , ( 10 / 3, "Use ONLY NUMBERS (like 17 or 3.14)." )
        , ( 10 / 3, "Use ONLY PLACES or LOCATIONS (like Hawaii)" )
...
update msg model =
    case msg of
        ...
        NewRule newRule ->
            -- NOTE: There must exist >> 3 rules generatable
    ...
    let
        timeAndRule =
            if model.timeRemaining > 0 then
                div []
                    [ p [] [ text <| "Time left: " ++ String.fromInt model.timeRemaining ++ "s" ]
                    , p [] [ text model.rule ]
                    ]
