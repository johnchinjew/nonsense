...
var author$project$Main$Model = F6(
	function (object, rule, timeRemaining, score1, score2, showRules) {
		return {object: object, rule: rule, score1: score1, score2: score2, showRules: showRules, timeRemaining: timeRemaining};
	});
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A6(author$project$Main$Model, '???', '???', 0, 0, 0, false),
...
var author$project$Main$NewObject = function (a) {
	return {$: 'NewObject', a: a};
};
var author$project$Main$NewRule = function (a) {
	return {$: 'NewRule', a: a};
};
var author$project$Main$maxScore = 7;
var author$project$Main$intToScore = function (score) {
	return (score < 0) ? 0 : ((_Utils_cmp(score, author$project$Main$maxScore) > 0) ? author$project$Main$maxScore : score);
};
...
var author$project$Main$objects = elm$core$Array$fromList(
	_List_fromArray(
...
var author$project$Main$rules = elm$core$Array$fromList(
	_List_fromArray(
		['One word that rhymes with ___', 'One word that starts with the letter _', 'One Texture word', 'One Emotion word', 'One Action word', 'One Sight word', 'One Color word', 'One Size word', 'One Smell word', 'One Taste word', 'One word of any kind', 'A number (like 17 or π)', 'Only sound effects', 'Only hand motions']));
		...
		switch (msg.$) {
			case 'GetNewObject':
				return _Utils_Tuple2(
					...
					A2(
						elm$random$Random$generate,
						author$project$Main$NewObject,
						A2(
							elm$random$Random$int,
							0,
							elm$core$Array$length(author$project$Main$objects) - 1)));
			case 'NewObject':
				var newObjectIndex = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							object: A2(
								...
								'!',
								A2(elm$core$Array$get, newObjectIndex, author$project$Main$objects))
						}),
					elm$core$Platform$Cmd$none);
			case 'GetNewRule':
				return _Utils_Tuple2(
					...
					A2(
						elm$random$Random$generate,
						author$project$Main$NewRule,
						A2(
							elm$random$Random$int,
							0,
							elm$core$Array$length(author$project$Main$rules) - 1)));
			case 'NewRule':
				var newRuleIndex = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							rule: A2(
								elm$core$Maybe$withDefault,
								'!',
								A2(elm$core$Array$get, newRuleIndex, author$project$Main$rules))
						}),
					elm$core$Platform$Cmd$none);
			case 'NewTimer':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{timeRemaining: author$project$Main$timeLimit}),
					elm$core$Platform$Cmd$none);
			case 'NewTime':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'IncrScore1':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							score1: author$project$Main$intToScore(model.score1 + 1)
						}),
					elm$core$Platform$Cmd$none);
			case 'DecrScore1':
				return _Utils_Tuple2(
			...
			case 'IncrScore2':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							score2: author$project$Main$intToScore(model.score2 + 1)
						}),
					elm$core$Platform$Cmd$none);
			case 'DecrScore2':
				return _Utils_Tuple2(
...
var author$project$Main$DecrScore1 = {$: 'DecrScore1'};
var author$project$Main$DecrScore2 = {$: 'DecrScore2'};
var author$project$Main$GetNewObject = {$: 'GetNewObject'};
var author$project$Main$GetNewRule = {$: 'GetNewRule'};
var author$project$Main$HideInstructions = {$: 'HideInstructions'};
var author$project$Main$IncrScore1 = {$: 'IncrScore1'};
var author$project$Main$IncrScore2 = {$: 'IncrScore2'};
var author$project$Main$NewTimer = {$: 'NewTimer'};
var author$project$Main$ShowInstructions = {$: 'ShowInstructions'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$HideInstructions)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Hide instructions')
							])),
						A2(
						elm$html$Html$ol,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Together, reps draw a single shared object. Teams will compete to guess this object.')
									])),
								A2(
								elm$html$Html$li,
								_List_Nil,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Rep draws a random rule. Can skip once per round.')
											])),
										A2(
										elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												elm$html$Html$text('Rep gives a hint to their team obeying that rule.')
											])),
										A2(
										elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												elm$html$Html$text('Team must settle on a single guess per hint.')
											]))
									])),
								A2(
								elm$html$Html$li,
								...
								_List_fromArray(
									[
										elm$html$Html$text('The first team to guess the object gets 1 point.')
									])),
								A2(
								elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										elm$html$Html$text('After the object is guessed, each team picks 1 new rep. ')
									])),
								A2(
								elm$html$Html$li,
								_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$ShowInstructions)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('View instructions')
							]))
					])),
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$GetNewObject)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('New object')
					])),
				A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Your object: ' + model.object)
					])),
				A2(elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$GetNewRule)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('New rule')
					])),
				A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Give a hint using: ' + model.rule)
					])),
				A2(elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$NewTimer)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('New timer')
					])),
				(model.timeRemaining > 0) ? A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(model.timeRemaining) + 's')
					])) : A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Out of time!')
					])),
				A2(elm$html$Html$hr, _List_Nil, _List_Nil),
				(_Utils_cmp(model.score1, author$project$Main$maxScore) > -1) ? A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Team 1 wins!')
					])) : ((_Utils_cmp(model.score2, author$project$Main$maxScore) > -1) ? A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Team 2 wins!')
					])) : A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						'First team to ' + (elm$core$String$fromInt(author$project$Main$maxScore) + ' wins!'))
					]))),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Team 1: '),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$DecrScore1)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('-')
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromInt(model.score1))
							])),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$IncrScore1)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						elm$html$Html$text('Team 2: '),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$DecrScore2)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('-')
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromInt(model.score2))
							])),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$IncrScore2)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+')
